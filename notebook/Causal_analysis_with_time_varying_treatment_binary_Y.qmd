---
title: "Causal analysis with time-varying treatment (binary Y)"
format: html
editor: visual
---
...
This code is edited from Kuan Liu's "R Tutorials - Introduction to causal inference and statistical methods for causal analysis in health services and outcome research" (<https://kuan-liu.github.io/causal_Quarto/section3.html>), with special acknowledgement to Yutong Lu who developed the original code.
...
causaldata <- read.csv("../Data/binary_outcome_data.csv", header = TRUE, fileEncoding="UTF-8-BOM")
